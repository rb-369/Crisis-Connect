...
export default function AdminDashboard({ onOpenMap, currentUser, onOpenAuthModal }) {
  ...
  return (
    <div className="py-2 sm:py-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
        ...
        <div className="flex flex-wrap sm:flex-nowrap items-center gap-2 w-full md:w-auto">
          <button
            ...
            className="flex-1 sm:flex-initial justify-center px-3 py-2 rounded-xl bg-white hover:bg-[#F1F5F9] border border-[#CBD5E1] text-[#475569] hover:text-[#0F172A] transition flex items-center space-x-1.5 text-xs font-bold shadow-sm"
          >
          ...
          <button
            onClick={onOpenMap}
            className="flex-1 sm:flex-initial justify-center px-4 py-2 rounded-xl bg-[#0F172A] hover:bg-[#1E293B] text-white transition flex items-center space-x-2 text-xs font-extrabold shadow-sm"
          >
      ...
      {/* Filter Tabs */}
      <div className="flex items-center gap-2 mb-5 border-b border-[#CBD5E1] pb-3 overflow-x-auto no-scrollbar sm:flex-wrap">
        {[
            ...
            return (
              ...
              >
                <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
                  ...
                  <div className="grid grid-cols-2 sm:flex sm:flex-wrap items-center gap-1.5 sm:gap-2 pt-3 lg:pt-0 border-t lg:border-t-0 border-[#E2E8F0] w-full lg:w-auto">
                    {/* Approve Action */}
                    <button
                      ...
                      className="px-3 py-2 rounded-xl bg-[#16A34A] hover:bg-[#15803D] text-white text-xs font-bold transition flex items-center justify-center space-x-1.5 disabled:opacity-30 shadow-sm cursor-pointer"
                    >
                    ...
                    <button
                      ...
                      className="px-3 py-2 rounded-xl bg-[#D97706] hover:bg-[#B45309] text-white text-xs font-bold transition flex items-center justify-center space-x-1.5 disabled:opacity-30 shadow-sm cursor-pointer"
                    >
                    ...
                    <button
                      ...
                      className="px-3 py-2 rounded-xl bg-[#DC2626] hover:bg-[#B91C1C] text-white text-xs font-bold transition flex items-center justify-center space-x-1.5 disabled:opacity-30 shadow-sm cursor-pointer"
                    >
                    ...
                    {req.status !== 'expired' && (
                      <button
                        ...
                        className="px-3 py-2 rounded-xl bg-slate-800 hover:bg-slate-900 text-amber-300 text-xs font-bold transition flex items-center justify-center space-x-1.5 disabled:opacity-30 shadow-sm cursor-pointer"
                      >
                    ...
                    {req.status !== 'cancelled' && (
                      <button
                        ...
                        className="col-span-2 sm:col-span-1 px-3 py-2 rounded-xl bg-slate-100 hover:bg-red-50 text-red-600 border border-slate-300 hover:border-red-300 text-xs font-bold transition flex items-center justify-center space-x-1 disabled:opacity-30 shadow-2xs cursor-pointer"
                      >
